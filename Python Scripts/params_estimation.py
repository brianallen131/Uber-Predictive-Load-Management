...
x_ij[1][2] = probability(d_1_2, surge, W_sub, P_sub, theta)
x_ij[2][1] = probability(d_1_2, surge, W_sub, P_sub, theta)

x_ij[1][3] = probability(d_1_3, surge, W_sub, P_sub, theta)
x_ij[3][1] = probability(d_1_3, surge, W_sub, P_sub, theta)

x_ij[2][3] = probability(1.25*d_1_2, surge, W_sub, P_sub, theta)
x_ij[3][2] = probability(1.25*d_1_2, surge, W_sub, P_sub, theta)
...
c_ij[2][3] = d_1_2 * 1.25 * cost_per_min * p_idle
c_ij[3][2] = d_1_2 * 1.25 * cost_per_min * p_idle
